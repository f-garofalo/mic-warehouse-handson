...
// ErrArticleNotFound aliases the canonical port sentinel (interfaces) so every
// layer matches the same error via errors.Is. Kept under this name for the
// repositories package's existing call sites and tests.
